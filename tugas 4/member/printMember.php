...
$memberquer = mysqli_query($conn, "SELECT * FROM member");
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="container mx-auto p-8">
        ...
        <div class="printable">
            <h3 class="text-2xl font-bold text-center mb-6">Detail Member</h3>
            <table class="min-w-full border">
                <thead class="bg-gray-800 text-white">
                    <tr>
                        <th class="py-3 px-4 border">No.</th>
                        <th class="py-3 px-4 border">Nama Member</th>
