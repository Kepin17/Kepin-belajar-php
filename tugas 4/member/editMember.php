...
$member_id = $_GET['id'];
$getQuery = mysqli_query($conn, "SELECT * FROM member WHERE member_id = '$member_id'");
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-6">
                <form method="post" action="update_pros.php" onsubmit="return validateForm()">
                    <div class="space-y-4">
                        <div>
                            <label for="member_id" class="block text-gray-700 text-sm font-bold mb-2">ID</label>
                            <input type="text" 
